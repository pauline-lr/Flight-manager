...
public class AddFlightForm extends JPanel {
    ...
    public void initForm(){
        ...
        arrival = new JLabel("Arrivée : ");
        arrival.setHorizontalAlignment(SwingConstants.RIGHT);
        this.add(arrival);

        date = new Date();
        spinnerModel = new SpinnerDateModel(date, null, null, Calendar.DATE);
        spinner = new javax.swing.JSpinner(spinnerModel);
        JSpinner.DateEditor arrivalDate = new JSpinner.DateEditor(spinner, "dd-MM-YYYY");
        spinner.setEditor(arrivalDate);
        add(arrivalDate);

        spinnerModel = new SpinnerDateModel(date, null, null, Calendar.MINUTE);
        spinner = new javax.swing.JSpinner(spinnerModel);
        JSpinner.DateEditor arrivalTime = new JSpinner.DateEditor(spinner, "HH:mm");
        spinner.setEditor(arrivalTime);
        add(arrivalTime);
